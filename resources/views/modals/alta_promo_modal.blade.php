<div id="altapromo" class="modal">
    <div class="modal-content">
      <h4>Alta</h4>
      <p class="flow-text">Dar de alta promo?</p>
    </div>
    <div class="modal-footer">
        <a class="modal-close waves-effect waves-green btn-flat">Cancelar</a>
        <a class="modal-close waves-effect waves-green btn-flat" onclick="altaPromo('{{route('promos_change_status')}}', '1','{{$tipo}}')">Dar alta</a>
    </div>
  </div>
  <script>
...
function altaPromo(url, status, tipo){
    if(url!='')
    {
