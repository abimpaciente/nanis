<div id="altaempleado" class="modal">
    <div class="modal-content">
      <h4>Alta</h4>
      <p class="flow-text">Dar de alta empleado?</p>
    </div>
    <div class="modal-footer">
        <a class="modal-close waves-effect waves-green btn-flat">Cancelar</a>
        <a class="modal-close waves-effect waves-green btn-flat" onclick="altaEmpleado('{{route('empleados_change_status')}}', '1')">Dar alta</a>
    </div>
  </div>
  <script>
...
function altaEmpleado(url, status){
    if(url!='')
    {
