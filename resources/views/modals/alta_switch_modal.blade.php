<div id="altaswitch" class="modal">
    <div class="modal-content">
      <h4>Alta</h4>
      <p class="flow-text">Prender Switch?</p>
    </div>
    <div class="modal-footer">
        <a class="modal-close waves-effect waves-green btn-flat">Cancelar</a>
        <a class="modal-close waves-effect waves-green btn-flat" onclick="altaSwitch('{{route('switch_change_status')}}', '1')">Prender</a>
    </div>
  </div>
  <script>
...
function altaSwitch(url, status){
    if(url!='')
    {
