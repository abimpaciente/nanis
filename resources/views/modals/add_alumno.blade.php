<div id="addalumno" class="modal modal-fixed-footer">
  <div class="modal-header red darken-3 center-align" style="color:white;"><h4>Agregar Alumno</h4></div>

    <div class="modal-content">
      <meta name="csrf-token-modal_alumno_add" content="{{ csrf_token() }}">   
      <div class="row" id="content_add_alumno_modal">
    ...
    <div class="modal-footer">
        ...
        <a class="modal-close waves-effect waves-green btn-flat" onclick="InsertAlumno('{{route('alumnos_insert.store')}}')">Guardar</a>
    </div>
  </div>
  <style>
    #toast-container {
...
// Or with jQuery
  ...
  function AddAlumno(){
    ...
    data.append('_token', $("meta[name='csrf-token-modal_alumno_add']").attr("content"));


    $.ajax({
        url:'{{route('alumnos_addmodal')}}',
        type:'POST',
        contentType:false,
        data:data,
        dataType: "html",
        ...
        success:function (data) {
            $('#content_add_alumno_modal').html(data)
            offLoad()
        },
