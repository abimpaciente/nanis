<div id="altaalumno" class="modal">
    <div class="modal-content">
      <h4>Alta</h4>
      <p class="flow-text">Quieres dar de alta este alumno?</p>
    </div>
    <div class="modal-footer">
        <a class="modal-close waves-effect waves-green btn-flat">Cancelar</a>
        <a class="modal-close waves-effect waves-green btn-flat" onclick="altaAlumno('{{route('alumnos_change_status')}}', '1')">Dar alta</a>
    </div>
  </div>
  <script>
...
function altaAlumno(url, status){
    if(url!='')
    {
