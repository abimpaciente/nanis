<div id="altausuario" class="modal">
    <div class="modal-content">
      <h4>Alta</h4>
      <p class="flow-text">Dar de alta {{$tipo}}?</p>
    </div>
    <div class="modal-footer">
        <a class="modal-close waves-effect waves-green btn-flat">Cancelar</a>
        <a class="modal-close waves-effect waves-green btn-flat" onclick="altaUsuario('{{route('usuarios_change_status')}}', '1','{{$tipo}}')">Dar alta</a>
    </div>
  </div>
  <script>
...
function altaUsuario(url, status, tipo){
    if(url!='')
    {
