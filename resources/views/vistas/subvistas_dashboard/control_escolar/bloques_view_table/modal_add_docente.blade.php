...
function b64toBlob(b64Data, contentType, sliceSize) 
{
  ...
  <div class="input-field col s12">
    <input id="clave_profesional" type="text" class="validate">
    <label for="clave_profesional">Clave Profesional</label>
  </div>
  <div class="input-field col s12">
    <input id="cedula_fiscal" type="text" class="validate">
    <label for="cedula_fiscal">Cédula Fiscal</label>
  </div>
  <div class="input-field col s12">
