...
<div class="col s12">
    ...
    align-items: center;">
        <div class="col s6 m6 l6">
            <p class="flow-text" style="font-size: 35px;">Biblioteca Digital</p>
            <p class="flow-text" style="color: rgb(126, 126, 126)"><small>Agrega libros digitales en este apartado.</small></p>
        </div>
