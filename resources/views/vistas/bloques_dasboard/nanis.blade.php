...
<div class="col s12">
    ...
    align-items: center;">
        <div class="col s6 m6 l6">
            <p class="flow-text" style="font-size: 35px;">Nanis</p>
            <p class="flow-text" style="color: rgb(126, 126, 126)"><small>Encuentra las Nanis registradas.</small></p>
        </div>
...
<div class="col s12">
    <div class="row" style="background: white; border-radius: 5px; box-shadow: 0px 1px 1px 1px  #c2c2c2; padding:10px;">
      <p class="flow-text">Nanis registradas</p>
        <div class="col s12">
            <div class="row">
